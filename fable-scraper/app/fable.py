...
def get_book_lists() -> BookListResponse:
    get_book_lists_url = (
        f"https://api.fable.co/api/v2/users/{USER_ID}/book_lists/?media_type=book"
    )
...
def get_books_from_list(
    ...
    url = f"https://api.fable.co/api/v2/users/{USER_ID}/book_lists/{book_list_id}/books?limit={limit}&offset={offset}"
